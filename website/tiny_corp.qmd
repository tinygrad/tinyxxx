...
1. **MovementOps**, operate on one tensor and move the data around, copy-free with [ShapeTracker](https://github.com/geohot/tinygrad/blob/master/tinygrad/shapetracker.py) .
